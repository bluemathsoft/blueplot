 ...
 */
var DataGroupN = (function (_super) {
    __extends(DataGroupN, _super);
    function DataGroupN(width, height, options) {
        var _this = _super.call(this, width, height, options) || this;
        _this._dataArray = [];
        return _this;
    }
    DataGroupN.prototype.add = function (data, plotType) {
        this._dataArray.push(data);
        this._plotTypeArray.push(plotType);
        this._update();
    };
    DataGroupN.prototype._computeTransform = function () {
        var data = [];
        var xmin = 0;
        var xmax = 0;
    ...
    DataGroupN.prototype._genLineDom = function (data, style) {
        var _this = this;
    ...
    DataGroupN.prototype._genScatterDom = function (data, style, radius) {
        var _this = this;
        var g = document.createElementNS(NS_SVG, 'g');
        g.setAttribute('class', 'plot-content');
    ...
    DataGroupN.prototype._genBarDom = function (data, style, barwidth) {
        var _this = this;
        var g = document.createElementNS(NS_SVG, 'g');
        g.setAttribute('class', 'plot-content');
    ...
    DataGroupN.prototype._update = function () {
